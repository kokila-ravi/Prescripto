...
const Doctors = () => {
  ...
  const applyFilter = () => {
    if (speciality) {
      // Case-insensitive filtering by converting to lowercase
  ...
  // Trigger filtering whenever doctors data or speciality changes
  useEffect(() => {
    applyFilter();
  }, [doctors, speciality]);

  // console.log('Speciality from URL:', speciality);
  // console.log('Filtered Doctors:', filterDoc);   // Debugging filtered list
